...
def webhook_issue_credential():
    ...
    if cred_ex.get("state") == "offer_received":
        ...
        for attribute in attributes:
            cred_template["credentialSubject"][attribute.get("name")] = attribute.get(
                "value"
            )
...
def webhook_issue_credential_v2_0():
    ...
    if cred_ex.get("state") == "offer-received":
        ...
        cred_input = {
            "cred_def_id": cred_ex.get("by_format")
            .get("cred_offer")
            .get("anoncreds")
            .get("cred_def_id"),
            "attrs": {},
...
def webhook_present_proof_v2_0():
    ...
    if pres_ex.get("state") == "request-received":
        pres_req = PresentationRequest(
            ...
            attributes=pres_ex.get("by_format")
            .get("pres_request")
            .get("anoncreds")
            .get("requested_attributes"),
            predicates=pres_ex.get("by_format")
            .get("pres_request")
            .get("anoncreds")
        ...
        pres_name = (
            pres_ex.get("by_format").get("pres_request").get("anoncreds").get("name")
        )
        notification = Notification(
            type="pres_request",
